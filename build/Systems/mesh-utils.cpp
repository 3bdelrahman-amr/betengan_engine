...
#define WHITE   Betengan::Color(255, 255, 255, 255)
#define GRAY    Betengan::Color(128, 128, 128, 255)
#define BLACK   Betengan::Color(  0,   0,   0, 255)
#define RED     Betengan::Color(255,   0,   0, 255)
#define GREEN   Betengan::Color(  0, 255,   0, 255)
#define BLUE    Betengan::Color(  0,   0, 255, 255)
#define MAGENTA Betengan::Color(255,   0, 255, 255)
#define YELLOW  Betengan::Color(255, 255,   0, 255)
#define CYAN    Betengan::Color(  0, 255, 255, 255)

/*bool Betengan::mesh_utils::loadOBJ(Mesh &mesh, const char* filename) {
    ...
    std::vector<Betengan::Vertex> vertices;
    ...
    std::unordered_map<Betengan::Vertex, GLuint> vertex_map;
    ...
    mesh.create({Betengan::setup_buffer_accessors<Vertex>});
...
/*void Betengan::mesh_utils::Cuboid(Mesh& mesh,
            bool colored_faces,
...
void Betengan::mesh_utils::Sphere(Entity e,MeshSystem* sys,Mesh& mesh, const glm::ivec2& segments, bool colored,
    ...
    for(int lat = 0; lat <= segments.y; lat++){
        ...
        for(int lng = 0; lng <= segments.x; lng++){
            ...
            Betengan::Color color = colored ? Betengan::Color(127.5f * (normal + 1.0f), 255) : WHITE;
    ...
    // Create and populate the OpenGL objects in the mesh
   // if (sys->isCreated(e)) sysdestroy();
    sys->create(e,{Betengan::setup_buffer_accessors<Vertex>});
    sys->setVertexData(e,0, vertices);
    sys->setElementData(e,elements);
}

/*void Betengan::mesh_utils::Plane(Mesh& mesh, const glm::ivec2& resolution, bool colored,
    ...
    for(it.x = 0; it.x <= resolution.x; it.x++){
        ...
        for(it.y = 0; it.y <= resolution.y; it.y++){
            ...
            Color color = colored ? glm::mix(
                    glm::mix(Color(255, 0, 0, 255), Betengan::Color(0, 255, 0, 255), uv.s),
                    glm::mix(Betengan::Color(255, 255, 0, 255), Betengan::Color(0, 0, 255, 255), uv.s),
                    uv.t) : WHITE;
